          ...
          <div className="relative z-10 flex flex-col xl:flex-row xl:items-center xl:justify-between gap-8">
            ...
            <div className="space-y-5">
              ...
              <div className="flex flex-wrap gap-3">
                <Badge variant="success">{agents.length} agentes ativos</Badge>
          ...
          <div className="flex flex-col md:flex-row gap-4 w-full">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full h-12 pl-12 pr-4 rounded-2xl border border-slate-800 bg-slate-900/70 text-white placeholder:text-slate-500 outline-none focus:border-cyan-500 transition"
              />
            </div>
